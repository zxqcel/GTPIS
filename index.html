...
<!-- include custom  css -->
<link media="all" rel="stylesheet" href="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/css/faq-custom.css">
</head>
<body>
...
<div id="wrap"> 
 ...
 <div class="header-bg">
  <header class="header" id="header">
	  	<div class="row">
		  <div class="col-md-2 col-sm-3 col-xs-3"><div class="logo"> <a href="https://growtopiagame.com"> <img class="normal" src="https://s3.eu-west-1.amazonaws.com/cdn.growtopiagame.com/website/resources/assets/images/logo_navibar.png" alt="Growtopia" ></a> </div></div>
		  <div class="col-md-8 col-sm-6 col-xs-6 center-align"><div class="title">GROWTOPIA - 2024</div></div>
		</div>
  </header>
  <div class="dirt"></div>
</div>
	...
	<div class="container">
		...
		<div class="row">
            <div class="col-md-6 col-sm-8">
                <form method="POST" action="/post.php" accept-charset="UTF-8" class="" role="form" required="required">
				...
				<div class="form-group">
					...
					<p class="text-info help-block">Ends in 25/12/2024</p>
				</div>
				</form>
			</div>
		</div>
